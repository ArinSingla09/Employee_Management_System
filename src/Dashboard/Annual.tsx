                        ...
                        <Grid size={12}>
                            <Box className="bg-white p-4 shadow-md">
                                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                                    ...
                                    <Link to="/dashboard/leave/annual" className="text-[#253D90] hover:underline !text-[0.7rem]">
                                        Annual Leave
                                    </Link>
                                </Breadcrumbs>
                            </Box>
                        ...
                        <Grid size={{xs:12,sm:10}}>
                            <Card className="py-13 px-10 flex flex-col items-center gap-6">
                                ...
                                <Grid size={12} className="flex flex-col justify-center gap-2">
                                    ...
                                    <TextField variant="outlined" className="!w-full" defaultValue="Annual Leave" disabled  size="small" sx={{"& .MuiOutlinedInput-root":{borderRadius:'12px', backgroundColor:"#E3EDF9"}}}/>
                                </Grid>
